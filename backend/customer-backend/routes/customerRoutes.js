...
router.post('/send-request', verifyCustomer, customerController.sendRequest);
router.get('/fixpert-location', verifyCustomer, customerController.getFixpertLocation);
